...
class Metaclass_BoundingBox(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from custom_messages.msg import Point
...
class BoundingBox(metaclass=Metaclass_BoundingBox):
    ...
    _fields_and_field_types = {
        'low_left': 'custom_messages/Point',
        'top_right': 'custom_messages/Point',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['custom_messages', 'msg'], 'Point'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['custom_messages', 'msg'], 'Point'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from custom_messages.msg import Point
        self.low_left = kwargs.get('low_left', Point())
        from custom_messages.msg import Point
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.low_left != other.low_left:
            return False
    ...
    @builtins.property
    def low_left(self):
        """Message field 'low_left'."""
        return self._low_left

    @low_left.setter
    def low_left(self, value):
        if __debug__:
            from custom_messages.msg import Point
            assert \
                isinstance(value, Point), \
                "The 'low_left' field must be a sub message of type 'Point'"
        self._low_left = value
