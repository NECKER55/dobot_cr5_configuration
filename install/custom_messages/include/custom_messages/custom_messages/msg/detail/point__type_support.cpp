...
{
  new (message_memory) custom_messages::msg::Point(_init);
}

void Point_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_messages::msg::Point *>(message_memory);
  typed_message->~Point();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Point_message_member_array[3] = {
  {
    ...
    offsetof(custom_messages::msg::Point, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_messages::msg::Point, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_messages::msg::Point, z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Point_message_members = {
  ...
  "Point",  // message name
  3,  // number of fields
  sizeof(custom_messages::msg::Point),
...
get_message_type_support_handle<custom_messages::msg::Point>()
{
  return &::custom_messages::msg::rosidl_typesupport_introspection_cpp::Point_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_messages, msg, Point)() {
  return &::custom_messages::msg::rosidl_typesupport_introspection_cpp::Point_message_type_support_handle;
}
