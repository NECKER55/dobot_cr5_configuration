...
{
  new (message_memory) custom_messages::msg::BoundingBox(_init);
}

void BoundingBox_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_messages::msg::BoundingBox *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BoundingBox_message_member_array[2] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<custom_messages::msg::Point>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(custom_messages::msg::BoundingBox, low_left),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_messages::msg::BoundingBox, top_right),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BoundingBox_message_members = {
  ...
  2,  // number of fields
  sizeof(custom_messages::msg::BoundingBox),
...
{
  return &::custom_messages::msg::rosidl_typesupport_introspection_cpp::BoundingBox_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_messages, msg, BoundingBox)() {
  return &::custom_messages::msg::rosidl_typesupport_introspection_cpp::BoundingBox_message_type_support_handle;
}
