...
#include "custom_messages/msg/detail/bounding_box__rosidl_typesupport_fastrtps_c.h"
...
#include "custom_messages/msg/detail/point__functions.h"  // low_left, top_right

// forward declare type support functions
size_t get_serialized_size_custom_messages__msg__Point(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_custom_messages__msg__Point(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_messages, msg, Point)();


using _BoundingBox__ros_msg_type = custom_messages__msg__BoundingBox;
  ...
  // Field name: low_left
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, custom_messages, msg, Point
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->low_left, cdr))
    {
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_custom_messages__msg__Point(
...
static uint32_t _BoundingBox__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_messages__msg__BoundingBox(
  ...
  size_t current_alignment)
{
  ...
  // member: low_left
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_custom_messages__msg__Point(
  ...
  if (is_plain) {
    ...
    using DataType = custom_messages__msg__BoundingBox;
    is_plain =
      (
...
static size_t _BoundingBox__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_messages__msg__BoundingBox(
