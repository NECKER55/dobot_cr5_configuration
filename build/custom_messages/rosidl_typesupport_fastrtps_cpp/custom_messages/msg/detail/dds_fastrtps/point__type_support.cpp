...
#include "custom_messages/msg/detail/point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_messages::msg::Point & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_messages::msg::Point & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_messages::msg::Point;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const custom_messages::msg::Point *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_messages::msg::Point *>(
    untyped_ros_message);
...
{
  return &custom_messages::msg::typesupport_fastrtps_cpp::_Point__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_messages, msg, Point)() {
  return &custom_messages::msg::typesupport_fastrtps_cpp::_Point__handle;
}
