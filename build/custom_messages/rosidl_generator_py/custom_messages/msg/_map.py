...
class Metaclass_Map(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from custom_messages.msg import Object
...
class Map(metaclass=Metaclass_Map):
    ...
    _fields_and_field_types = {
        'work_space': 'custom_messages/BoundingBox',
        'objects': 'sequence<custom_messages/Object>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['custom_messages', 'msg'], 'BoundingBox'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['custom_messages', 'msg'], 'Object')),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from custom_messages.msg import BoundingBox
        self.work_space = kwargs.get('work_space', BoundingBox())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.work_space != other.work_space:
            return False
    ...
    def work_space(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'work_space' field must be a sub message of type 'BoundingBox'"
